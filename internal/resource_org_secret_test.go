...
func TestOrgSecretResourceWriteOnly(t *testing.T) {
	t.Parallel()
...
`, org.ID, name, woodpecker.EventPush),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttrSet("woodpecker_org_secret.test_secret", "id"),
						resource.TestCheckResourceAttr("woodpecker_org_secret.test_secret", "name", name),
						resource.TestCheckResourceAttr("woodpecker_org_secret.test_secret", "value_wo_version", "1"),
						resource.TestCheckNoResourceAttr("woodpecker_org_secret.test_secret", "value"),
						resource.TestCheckNoResourceAttr("woodpecker_org_secret.test_secret", "value_wo"),
						resource.TestCheckTypeSetElemAttr("woodpecker_org_secret.test_secret", "events.*", woodpecker.EventPush),
					),
				},
...
`, org.ID, name, woodpecker.EventPush),
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("woodpecker_org_secret.test_secret", "value_wo_version", "2"),
						resource.TestCheckNoResourceAttr("woodpecker_org_secret.test_secret", "value_wo"),
					),
				},
			},
