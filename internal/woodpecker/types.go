...
const (
	ApprovalModeNone         ApprovalMode = "none"          // require approval for no events
	ApprovalModeForks        ApprovalMode = "forks"         // require approval for PRs from forks
	ApprovalModePullRequests ApprovalMode = "pull_requests" // require approval for all PRs (default)
	ApprovalModeAllEvents    ApprovalMode = "all_events"    // require approval for all events
)
...
func (m ApprovalMode) Valid() bool {
	...
	case ApprovalModeNone,
		ApprovalModeForks,
		ApprovalModePullRequests,
		ApprovalModeAllEvents:
		return true
	default:
		return false
	}
...
const (
	...
	VisibilityModeInternal VisibilityMode = "internal"
)
...
type (
	...
	RepoPatch struct {
		...
		Timeout                      *int64                     `json:"timeout,omitempty"`
		Visibility                   *VisibilityMode            `json:"visibility,omitempty"`
		AllowPullRequests            *bool                      `json:"allow_pr,omitempty"`
