...
func (d *repositoryDataSource) Schema(
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"trusted": schema.ObjectAttribute{
				Computed:       true,
				AttributeTypes: repositoryModelTrustedAttributes,
				Description: "when true, underlying pipeline containers get access to escalated capabilities " +
					"like mounting volumes",
			},
