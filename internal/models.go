...
func (m *repositoryModel) setValues(ctx context.Context, repo *woodpecker.Repo) diag.Diagnostics {
	...
	m.Trusted, diags = types.ObjectValueFrom(
		ctx,
...
func (m *repositoryModel) toWoodpeckerPatch(ctx context.Context) (*woodpecker.RepoPatch, diag.Diagnostics) {
	...
	diags.Append(m.NetrcTrustedPlugins.ElementsAs(ctx, &repo.NetrcTrustedPlugins, false)...)
	diags.Append(m.Trusted.As(ctx, &repo.Trusted, basetypes.ObjectAsOptions{UnhandledUnknownAsEmpty: true})...)
