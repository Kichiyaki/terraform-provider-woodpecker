...
- `trusted` (Object) when true, underlying pipeline containers get access to escalated capabilities like mounting volumes (see [below for nested schema](#nestedatt--trusted))
